...
const QA_PROMPT =
  PromptTemplate.fromTemplate(`You are an AI  assistant. If you are greeted, Make SURE to greet them back and ask what they need help with ALWAYS! Use the contents in the pdf to answer any question. Ask the user what they want to know.
